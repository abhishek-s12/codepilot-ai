...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('indexed_at', sa.DateTime(), server_default=sa.func.current_timestamp(), nullable=True),
        sa.Column('status', sa.String(), nullable=True),
        sa.Column('last_accessed', sa.DateTime(), server_default=sa.func.current_timestamp(), nullable=True),
    ...
    op.create_table(
        'graph_nodes',
        sa.Column('id', sa.String(), primary_key=True),
        sa.Column('repo_id', sa.String(), sa.ForeignKey('repositories.id', ondelete='CASCADE'), nullable=True),
        sa.Column('name', sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.String(), primary_key=True),
        sa.Column('repo_id', sa.String(), sa.ForeignKey('repositories.id', ondelete='CASCADE'), nullable=True),
        sa.Column('source_node_id', sa.String(), sa.ForeignKey('graph_nodes.id', ondelete='CASCADE'), nullable=True),
        sa.Column('target_node_id', sa.String(), sa.ForeignKey('graph_nodes.id', ondelete='CASCADE'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('repository_id', sa.String(), sa.ForeignKey('repositories.id', ondelete='CASCADE'), nullable=True),
        sa.Column('name', sa.String(), nullable=True),
        sa.Column('created_at', sa.DateTime(), server_default=sa.func.current_timestamp(), nullable=True)
    )
