...
const THEMES: Theme[] = [
  { id: "dark-default", name: "Deep Dark (Default)", bg: "bg-[#090c13]", border: "border-[#1c2230]", icon: <Moon className="w-4 h-4 text-accent" /> },
...
export default function ThemeManager() {
  ...
  // applyTheme is stable within this effect; including it would cause infinite loop
          ...
          return (
            <button
              ...
              className={`p-3.5 rounded-2xl border text-left flex items-center justify-between transition-all duration-200 cursor-pointer ${
                isSelected
                  ? "bg-accent text-bg/10 border-accent/40 text-white shadow-lg shadow-accent/5"
